...
//
//        // Konversi ke Image dan Resize
//        Image barcodeImage = barcodeIcon.getImage();
//        int barcodeWidth = 281;  // Lebar per barcode
//        int barcodeHeight = 259; // Tinggi per barcode
//
//        // Hitung ukuran gambar total untuk semua barcode
//        int baris = (int) Math.ceil(jumlahCetak / 5.0); // Maksimal 5 barcode per baris
//        int totalWidth = barcodeWidth * 5;              // Lebar total
//        int totalHeight = baris * barcodeHeight;        // Tinggi total
//
//        // Buat canvas gambar (BufferedImage)
//        BufferedImage canvas = new BufferedImage(totalWidth, totalHeight, BufferedImage.TYPE_INT_ARGB);
//        Graphics2D g2d = canvas.createGraphics();
//
//        // Gambar semua barcode ke dalam canvas
//        for (int i = 0; i < jumlahCetak; i++) {
//            int x = (i % 5) * barcodeWidth;  // Posisi X (kolom)
//            int y = (i / 5) * barcodeHeight; // Posisi Y (baris)
//            g2d.drawImage(barcodeImage, x, y, barcodeWidth, barcodeHeight, null);
//        }
//
//        g2d.dispose();
//
//        // Simpan canvas ke file PNG
//        String pathName = "D:\\QRCode\\";
//        String fileName = pathName + namaFile + "_" + tanggal + ".PNG";
//        File outputFile = new File(fileName);
//        ImageIO.write(canvas, "PNG", outputFile);
//
//        // Tampilkan pesan sukses
//        JOptionPane.showMessageDialog(null, "Barcode berhasil dicetak dalam 1 file!");
//
//        // Reset jika perlu
//        // reset();
//    } catch (Exception e) {
